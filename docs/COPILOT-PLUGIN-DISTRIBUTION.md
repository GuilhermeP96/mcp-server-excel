...
- **`excel-mcp`** — MCP Server with 32 tools (331 operations) for conversational AI (Claude Desktop, Copilot chat)
...
Provides the full MCP Server with 32 tools (331 operations) for conversational AI:
